...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-10 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spacces, Building Legacies-Explore Our Portfolio</p>
      ...
      <div className='overflow-hidden'>
        ...
        style={{ transform: `translateX(-${currentIndex * (100 / cardsToShow)}%)`}}>
            {projectsData.map((project, index) => (
                <div key={index} className='relative flex shrink-0 w-full sm:w-1/4 lg:w-1/4'>
